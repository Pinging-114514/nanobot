...
_REASONING_MIN_CHARS = 80  # enough new thinking content to justify a card edit (one paragraph)
_STREAM_MIN_CHARS = 80  # enough new content to justify a stream edit (one paragraph)
...
class TelegramChannel(BaseChannel):
    ...
    def __init__(self, config: Any, bus: MessageBus):
        ...
        self._edit_gate_interval = 1.0  # min seconds between edits per chat (backstop; content threshold paces real edits)
